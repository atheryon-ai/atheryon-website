...
// two function contact pages, which cost a click, taught nothing, and had no
// answer for a Data & AI enquiry. The form asks which practice instead;
// function CTAs still preset it via ?topic=.
