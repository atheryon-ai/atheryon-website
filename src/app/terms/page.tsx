  ...
  return (
    <DocPage>
      <DocBanner
        ...
        body="The terms that apply to your use of atheryon.com.au."
      />
        ...
        <div className="max-w-3xl space-y-12 text-charcoal/85 leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 list-none">
              <Bullet>Interfere with, disrupt, or attempt to gain unauthorised access to the Site or its underlying systems.</Bullet>
              <Bullet>Use automated scrapers, crawlers, or bots to harvest content at a rate that affects other users, except for well-behaved search-engine indexing.</Bullet>
              <Bullet>Submit unlawful, deceptive, defamatory, or harmful content via any form on the Site.</Bullet>
            </ul>
          </section>
      ...
      <DocFooter label="atheryon / legal / terms / end-of-document" />
    </DocPage>
  )
}
