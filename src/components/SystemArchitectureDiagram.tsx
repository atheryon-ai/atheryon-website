...
// sign-off gate + directorial archive. Monochrome (bone/charcoal/navy/ink); stroke
// encodes meaning: solid = data plane, dashed = control/audit plane.
//
        ...
        >
          ...
          <defs>
            <marker id="sa-arch-arrow" viewBox="0 0 10 10" refX="8.5" refY="5" markerWidth="6" markerHeight="6" orient="auto">
              <path d="M0 0 L10 5 L0 10 z" fill="#15171A" />
            </marker>
          </defs>
          ...
          {/* Data sources */}
          <rect x="140" y="24" width="760" height="38" fill="none" stroke="#15171A" strokeOpacity="0.55" />
          <text x="152" y="40" fontSize="9" fill="#15171A" fillOpacity="0.55">§01</text>
          <text x="152" y="52" fontSize="10.5" fill="#15171A" fontWeight="600">{data.dataSources.name}</text>
          <text x="520" y="47" fontSize="9" fill="#15171A" fillOpacity="0.7">{data.dataSources.detail}</text>
          <g stroke="#15171A" strokeOpacity="0.5" fill="none">
          ...
          <text x="140" y="84" fontSize="8.5" letterSpacing="1.5" fill="#15171A" fontWeight="700">
          ...
          {[170, 300, 430, 560, 690].map((gx) => (
            <g key={gx}>
              <rect x={gx} y="102" width="64" height="36" rx="3" fill="none" stroke="#15171A" strokeOpacity="0.6" />
              <circle cx={gx + 32} cy="116" r="4" fill="none" stroke="#15171A" strokeOpacity="0.6" />
              <text x={gx + 32} y="132" textAnchor="middle" fontSize="6.5" fill="#15171A" fillOpacity="0.45">agent</text>
            </g>
          ))}
          <text x="800" y="124" fontSize="14" fill="#15171A" fillOpacity="0.4">· · ·</text>
          ...
          <text x="470" y="166" fontSize="7.5" fill="#15171A" fillOpacity="0.7">{data.etlAgents.output} →</text>

          {/* ODS slab */}
          <rect x="140" y="194" width="760" height="56" rx="3" fill="#15171A" fillOpacity="0.04" stroke="#15171A" strokeWidth="1.6" />
          <text x="152" y="214" fontSize="9" fill="#15171A" fillOpacity="0.55">§02</text>
          <text x="152" y="228" fontSize="11" fill="#15171A" fontWeight="700">{data.ods.name.toUpperCase()}</text>
          <text x="152" y="242" fontSize="8" fill="#15171A" fillOpacity="0.75">{data.ods.detail}</text>
          <text x="888" y="224" textAnchor="end" fontSize="8" fill="#15171A" fillOpacity="0.7">{data.ods.scale}</text>
          ...
          <text x="220" y="286" fontSize="7" fill="#15171A" fillOpacity="0.6">read →</text>

          {/* Operations agents tier (per business unit) */}
          <text x="140" y="284" fontSize="8.5" letterSpacing="1.5" fill="#15171A" fontWeight="700">
          ...
          {data.operationsAgents.units.slice(0, 5).map((u, i) => (
            <g key={u.name}>
              <rect x={OPS_X[i]} y="292" width={OPS_W[i]} height="58" rx="3" fill="none" stroke="#15171A" strokeOpacity="0.6" />
              <rect x={OPS_X[i]} y="292" width={OPS_W[i]} height="16" fill="#15171A" fillOpacity="0.06" />
              <text x={OPS_X[i] + 8} y="304" fontSize="8.5" fill="#15171A" fontWeight="600">{u.name}</text>
              <text x={OPS_X[i] + 8} y="324" fontSize="7.5" fill="#15171A" fillOpacity="0.7">{u.detail}</text>
            </g>
          ))}
          ...
          <rect x="140" y="378" width="760" height="30" fill="none" stroke="#0E1116" strokeWidth="1" />
          <rect x="143" y="381" width="754" height="24" fill="none" stroke="#0E1116" strokeWidth="1" />
          <text x="152" y="396" fontSize="9" fill="#0E1116" fontWeight="700">⌂ {c.signOff.name.toUpperCase()}</text>
          <text x="520" y="396" textAnchor="middle" fontSize="8" fill="#0E1116" fillOpacity="0.8">{c.signOff.detail}</text>

          {/* Outputs */}
          <line x1="520" y1="408" x2="520" y2="430" stroke="#15171A" strokeOpacity="0.5" markerEnd="url(#sa-arch-arrow)" />
          <rect x="140" y="430" width="760" height="38" fill="none" stroke="#15171A" strokeOpacity="0.55" />
          <text x="152" y="446" fontSize="9" fill="#15171A" fillOpacity="0.55">§04 → §05</text>
          <text x="152" y="458" fontSize="10.5" fill="#15171A" fontWeight="600">{data.outputs.name}</text>
          <text x="540" y="453" fontSize="9" fill="#15171A" fillOpacity="0.7">{data.outputs.detail}</text>

          {/* Orchestrator dashed control to both tiers */}
          <g stroke="#15171A" strokeOpacity="0.4" strokeDasharray="4 3" fill="none">
          ...
          <rect x="20" y="484" width="880" height="40" fill="#15171A" fillOpacity="0.05" stroke="#15171A" strokeOpacity="0.35" />
          <text x="34" y="504" fontSize="9.5" fill="#15171A" fontWeight="700" letterSpacing="0.5">{c.archive.name.toUpperCase()}</text>
          <text x="34" y="517" fontSize="8" fill="#15171A" fillOpacity="0.7">{c.archive.detail} · {c.deployment}</text>
          <path d="M820 408 C860 446 870 466 870 482" stroke="#15171A" strokeOpacity="0.45" strokeDasharray="4 3" fill="none" markerEnd="url(#sa-arch-arrow)" />
          <text x="828" y="436" fontSize="7" fill="#15171A" fillOpacity="0.6">log ↓</text>

          {/* Legend */}
          <g fontSize="8" fill="#15171A" fillOpacity="0.75">
            <line x1="20" y1="534" x2="44" y2="534" stroke="#15171A" strokeOpacity="0.7" />
            <text x="50" y="537">{data.legend.data}</text>
            <line x1="150" y1="534" x2="174" y2="534" stroke="#15171A" strokeOpacity="0.6" strokeDasharray="4 3" />
            ...
            <rect x="448" y="528" width="12" height="12" fill="none" stroke="#0E1116" />
            <rect x="450.5" y="530.5" width="7" height="7" fill="none" stroke="#0E1116" />
